    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_investment', models.DateTimeField(auto_now=True)),
                ('date_of_maturity', models.CharField(blank=True, max_length=50, null=True)),
                ('investor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='investor3', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
